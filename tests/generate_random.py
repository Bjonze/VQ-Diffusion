...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for i in range(batch_size):
            ...
            VQ_Diffusion_model.inference_generate_sample_with_condition(condition, truncation_rate=1.0, save_root=save_root_synth_, batch_size=4, guidance_scale=5.0, prior_rule=0, learnable_cf=True)
